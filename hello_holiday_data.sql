...
VALUES
    (1, 120, 'Cozy single room with an ocean view.', true, 1),
    (1, 150, 'Double room with modern decor and sea breeze.', true, 2),
    (1, 180, 'Spacious triple room with a private balcony.', true, 3),
    (1, 200, 'Luxurious quad suite with direct beach access.', true, 4),
    (1, 100, 'Comfortable single room with a garden view.', false, 1),
    (1, 140, 'Stylish double room overlooking the pool.', true, 2),
    (1, 175, 'Triple room with family-friendly amenities.', false, 3),
    (1, 210, 'Exclusive quad room with premium furnishings.', true, 4),
    (1, 130, 'Single room with minimalist design.', false, 1),
    (1, 160, 'Double room with scenic ocean views.', true, 2),
    (2, 90, 'Charming single room with mountain views.', false, 1),
    (2, 110, 'Cozy double room with rustic decor.', false, 2),
    (2, 150, 'Triple room with panoramic alpine views.', true, 3),
    (2, 180, 'Quad room with spacious seating area.', false, 4),
    (2, 85, 'Basic single room ideal for solo travelers.', false, 1),
    (2, 130, 'Comfortable double room with balcony access.', true, 2),
    (2, 160, 'Family triple room with extra beds.', true, 3),
    (2, 200, 'Luxury quad room with stunning mountain views.', true, 4),
    (2, 95, 'Small single room with compact design.', false, 1),
    (2, 125, 'Double room with a cozy atmosphere.', false, 2),
    (3, 110, 'Modern single room with stylish decor.', false, 1),
    (3, 140, 'Double room with excellent city views.', true, 2),
    (3, 170, 'Triple room with extra living space.', true, 3),
    (3, 210, 'Spacious quad room with premium furnishings.', true, 4),
    (3, 100, 'Cozy single room ideal for business travelers.', false, 1),
    (3, 150, 'Double room with a private balcony.', true, 2),
    (3, 180, 'Family triple room with modern amenities.', true, 3),
    (3, 220, 'Luxurious quad room with skyline views.', true, 4),
    (3, 120, 'Simple single room with efficient design.', false, 1),
    (3, 160, 'Comfortable double room near public transport.', false, 2),
    (4, 135, 'Single room with chic decor in the city center.', false, 1),
    (4, 175, 'Double room with large windows and urban views.', true, 2),
    (4, 200, 'Triple room with modern design and spacious layout.', false, 3),
    (4, 250, 'Quad room with luxury amenities and a balcony.', true, 4),
    (4, 120, 'Single room near shopping districts.', false, 1),
    (4, 150, 'Double room with comfortable bedding.', true, 2),
    (4, 190, 'Family-friendly triple room with city access.', false, 3),
    (4, 230, 'Quad room with premium furniture and views.', true, 4),
    (4, 140, 'Compact single room for short stays.', false, 1),
    (4, 180, 'Elegant double room with great amenities.', true, 2),
    (5, 90, 'Single room with tropical garden views.', false, 1),
    (5, 120, 'Double room with private balcony and pool access.', true, 2),
    (5, 150, 'Triple room with kid-friendly features.', false, 3),
    (5, 200, 'Quad suite with spacious living area.', true, 4),
    (5, 95, 'Basic single room with comfortable bedding.', false, 1),
    (5, 130, 'Double room with modern decor and amenities.', false, 2),
    (5, 170, 'Triple room with extra beds for families.', true, 3),
    (5, 210, 'Luxury quad room with beautiful views.', true, 4),
    (5, 105, 'Single room ideal for solo travelers.', false, 1),
    (5, 140, 'Stylish double room with private balcony.', true, 2)
